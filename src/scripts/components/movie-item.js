...
class MovieItem extends HTMLElement {
    ...
    render() {
        ...
        this.innerHTML = `
            <div class="cursor-pointer space-y-4 button-modal" onclick="${container}_${id}_modal.showModal()">
            ...
            <dialog id="${container}_${id}_modal" class="modal">
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form method="dialog" class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button class="ms-auto text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Close</button>
                        </form>
                    </div>
                </div>
            </dialog>
